...
(() => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const failedFiles = [];
        const jsonFiles = yield (0, utils_1.getPathsRecursively)(workspace);
        for (const file of jsonFiles) {
            const content = (yield fs_1.default.promises.readFile(file)).toString();
            try {
                JSON.parse(content);
            }
            catch (e) {
...
const core = __importStar(__nccwpck_require__(186));
const inputs_1 = __importDefault(__nccwpck_require__(180));
const getPathsRecursively = (p) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const paths = [];
    const { CHECK_RECURSIVELY } = (0, inputs_1.default)();
    try {
        ...
        for (const f of result) {
            if (['json'].includes((_a = f.split('.').pop()) !== null && _a !== void 0 ? _a : '')) {
                ...
                if (CHECK_RECURSIVELY)
                    paths.push(...(yield (0, exports.getPathsRecursively)(path_1.default.join(p, f))));
            }
        }
        return paths;
    }
